# 2026-06-19 — Initial architecture

Greenfield decisions for the journal MCP app: interface shape, repo layout, storage, embeddings, production stack, and deferred auth.

| Topic | File | Status |
|-------|------|--------|
| Tools-only MCP | [tools-only-mcp.md](tools-only-mcp.md) | accepted |
| Next.js monorepo | [nextjs-monorepo.md](nextjs-monorepo.md) | accepted |
